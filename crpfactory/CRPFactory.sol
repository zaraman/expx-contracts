 ...
 *                           (enables private pools with more than one liquidity provider)
...
contract CRPFactory {
     ...
     * @param factoryAddress - the EFactory instance used to create the underlying pool
    ...
    returns (ConfigurableRightsPool)
    {
        ...
        // The CRP will be the controller of the underlying Core EPool
